...
def load_documents(config):
    ...
    loader = SitemapLoader(
        config['SITE_MAP'],
        filter_urls=["https://docs.chainstack.com/docs/", "https://docs.chainstack.com/reference/"], # Only takes main docs and API ref
...
def create_vector_db(text, config):
    ...
    db = DeepLake(dataset_path=deeplake_path, embedding=embeddings, overwrite=True)
